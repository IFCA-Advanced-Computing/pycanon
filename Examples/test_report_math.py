...
report.get_anon_report(FILE_NAME_1, QI, SA, file_pdf = FILE_PDF_1, file_json = FILE_JSON_1)

FILE_NAME_2 = './Data/Processed/StudentsMath_Score_k5.csv'
FILE_PDF_2 = 'test_math_k5.pdf'
FILE_JSON_2 = 'test_math_k5.json'
report.get_anon_report(FILE_NAME_2, QI, SA, file_pdf = FILE_PDF_2, file_json = FILE_JSON_2)
